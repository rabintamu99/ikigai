   ...
   <div class="flex justify-center w-screen h-screen px-4 text-gray-700">
	...
	@include('components.sidebar-menu')
	   ...
	   @foreach ($posts as $post)
		   <div class="flex w-full  hover:shadow-lg g-white  shadow rounded-lg p-8 m-1 mb-5 border-b border-gray-300">
			 <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-400" src="{{ asset('storage/images/'.Auth::user()->avatar) }}" alt="Image Description">
			 <div class="flex flex-col flex-grow ml-4">
			   ...
			   <div>
				<img class="rounded" src="{{ asset('storage/posts/'.$post->image) }}" alt="No image to show">
			   </div>
