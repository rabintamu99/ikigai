		 ...
		 <div class="flex-grow h-0 overflow-auto">
		   <div class="flex w-full p-8 border-b-4 border-gray-300">
			 ...
			 <form action="post/create" method="post" enctype="multipart/form-data" class="flex flex-col flex-grow ml-4">
				 @csrf
			   <textarea class="p-3 bg-transparent border border-gray-500 rounded-sm" name="content" id="content"  rows="3" placeholder="What's happening? {{ Auth::user()->name }}"></textarea>
